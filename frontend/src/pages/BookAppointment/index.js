            ...
            <div className={styles.dataBlock}>
                <div className={styles.subBlock}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <label1x1 htmlFor="price">Price: </label1x1>
                        <div className={styles.pricetb}>
                            Rs. {formData.price}
                        </div>
                        ...
                        <label1x1 htmlFor="price">
                            Price:
                        </label1x1>
                        <select type="price" id="price" value={formData.test} onChange={handleInputChange} className={styles.pricetb}>
                           
                            {test.map(e => {
                                return (<option value={e.price}>{e.price}</option>);
                            })}
